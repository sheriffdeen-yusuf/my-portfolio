    ...
    <div className="grid-col-1 grid gap-8 px-20 py-10 md:grid-cols-2">
      ...
      <div className=" max-w-md  overflow-hidden rounded-xl bg-white shadow-lg">
        ...
        <div className="px-6 py-4">
          <div className="mb-2 text-xl font-bold">Project Title</div>
          <p className="text-base text-gray-700">
            StreamHub is your go-to online movie app, offering an extensive and
            ever-expanding collection of movies and TV shows. With a
            user-friendly interface and seamless streaming experience, it's the
            perfect entertainment companion for film enthusiasts of all ages.
          </p>
        </div>
        <div className="px-6 py-4">
          <a
